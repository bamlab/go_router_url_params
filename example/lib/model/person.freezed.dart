...
mixin _$Person {
 ...
 String get name;@JsonKey(fromJson: _parseAgeFromString) int get age;@JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson) PersonStatus? get status;
...
@useResult
$Res call({
 String name,@JsonKey(fromJson: _parseAgeFromString) int age,@JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson) PersonStatus? status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @JsonKey(fromJson: _parseAgeFromString)  int age, @JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson)  PersonStatus? status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Person() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(fromJson: _parseAgeFromString)  int age, @JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson)  PersonStatus? status)  $default,) {final _that = this;
switch (_that) {
case _Person():
return $default(_that.name,_that.age,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @JsonKey(fromJson: _parseAgeFromString)  int age, @JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson)  PersonStatus? status)?  $default,) {final _that = this;
switch (_that) {
case _Person() when $default != null:
return $default(_that.name,_that.age,_that.status);case _:
  return null;
...
class _Person extends Person {
  const _Person({required this.name, @JsonKey(fromJson: _parseAgeFromString) this.age = 0, @JsonKey(readValue: readObjectFromString, toJson: writeObjectToJson) this.status}): super._();
...
@JsonKey(fromJson: _parseIsActiveFromString) bool get isActive; String get label;
...
@useResult
$Res call({
@JsonKey(fromJson: _parseIsActiveFromString) bool isActive, String label
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _parseIsActiveFromString)  bool isActive,  String label)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PersonStatus() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _parseIsActiveFromString)  bool isActive,  String label)  $default,) {final _that = this;
switch (_that) {
case _PersonStatus():
return $default(_that.isActive,_that.label);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _parseIsActiveFromString)  bool isActive,  String label)?  $default,) {final _that = this;
switch (_that) {
case _PersonStatus() when $default != null:
return $default(_that.isActive,_that.label);case _:
  return null;
...
class _PersonStatus extends PersonStatus {
  const _PersonStatus({@JsonKey(fromJson: _parseIsActiveFromString) this.isActive = true, this.label = 'Active'}): super._();
  factory _PersonStatus.fromJson(Map<String, dynamic> json) => _$PersonStatusFromJson(json);

@override@JsonKey(fromJson: _parseIsActiveFromString) final  bool isActive;
